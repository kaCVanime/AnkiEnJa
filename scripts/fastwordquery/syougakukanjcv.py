...
DICT_PATH = u"C:/Users/Administrator/Downloads/jc/小学馆v3/Shogakukanjcv3.mdx"
JEV_PATH = u"C:/Users/Administrator/AppData/Roaming/Anki2/addons21/fastwq1/service/dict/jev_list.txt"
...
@register([u'本地词典-小学馆日汉v3', u'小学馆日汉v3'])
class syogakukanjcv(MdxService):
    ...
    def __init__(self):
        ...
        if not dict_path:
            ...
            for clazz in service_manager.mdx_services:
                ...
                if title.startswith(u'小学馆日汉v3'):
                    dict_path = service.dict_path
                    break

        self.jev_entries = set(line.strip() for line in open(JEV_PATH, encoding='utf-8'))
    ...
    def _find_meaning_tag(self, tag):
        return tag.name == 'p' and tag.attrs.get("data-orgtag") == "meaning" and not tag.attrs.get("type") == "補足"
            ...
            if first_text_node:
                ...
                if first_text_node_text.startswith(("[", "<")):
                    if first_text_node_text == text_content:
                        ...
                        def_obj["label"] = def_obj.get("label", "") + first_text_node_text
    ...
    def _get_subheads(self, name, target):
        ...
        for item in sections:
            obj = {"usage": item.find('div', attrs={"data-orgtag": "subheadword"}, recursive=False).get_text()}
    ...
    def injson(self):
        try:
            ...
            entries = soup.find_all('h2', recursive=False) + soup.find_all('h3', recursive=False)
            result = []
