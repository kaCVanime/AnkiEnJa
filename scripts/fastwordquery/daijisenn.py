...
DICT_PATH = (
    "C:/Users/Administrator/Downloads/Compressed/大辞泉202304/大辞泉202304/DJS.mdx"
)


@register(["本地词典-大辞泉", "大辞泉"])
class daijisen_mdx(MdxService):
    ...
    def hyouki(self):
        soup = parse_html(self.get_default_html())
        items = list(
            set(map(lambda t: t.get_text(), soup.find_all("headword", class_="表記")))
        )
        result = ""
